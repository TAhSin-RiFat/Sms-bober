...
// ==========================================
// 🔴 FIXED SERVICES (Swap, RedX, DeeptoPlay)
// ==========================================
...
for($i=1; $i<=10; $i++){
    $api_requests[] = [
        ...
        "headers" => ['Content-Type: application/json', 'Origin: https://redx.com.bd', 'Referer: https://redx.com.bd/']
    ];
}
